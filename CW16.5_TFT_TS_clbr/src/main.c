/* < Szymon Ostrowski - 30.10.2018 >
 * < CW16.5_TFT_TS_clbr - main.c >
 *
...
int main(void)
{
	...
	//ADC Config
	ADC1->CR2 = ADC_CR2_ADON | ADC_CR2_JEXTSEL | ADC_CR2_JEXTTRIG; //w³. przetwornika , software control bit , w³. ADC1
	delay_ms(10);
...
void clbr()
{
	...
	//pkt. 1 , delta
	TFT_putString(61,160,0xFFFF,1,"nacisnij punkt 1",0x0000);
	...
	TFT_putString(61,160,0xFFFF,1,"                ",0x0000);
	gpio_TC();
	...
	//pkt. 2 , skala
	TFT_putString(61,160,0xFFFF,1,"nacisnij punkt 2",0x0000);
	...
	TFT_putString(61,160,0xFFFF,1,"       OK       ",0x0000);
	delay_ms(800);
	gpio_TC();
}
